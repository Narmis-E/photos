# My Photo Collection
![Photos](https://img.shields.io/github/directory-file-count/narmis-e/photos%2Fimages%2Ffulls?label=Photos%3A) [![License: CC BY-SA 4.0](https://img.shields.io/badge/License-CC_BY--SA_4.0-lightgrey.svg)](https://creativecommons.org/licenses/by-sa/4.0/)
...
Thanks to [AJ](https://twitter.com/ajlkn) for the website template which [Ram Patra](https://github.com/rampatra/photography) enhanced for [jekyll](http://jekyllrb.com/).
